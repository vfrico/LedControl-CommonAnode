  ...
  class LedPrintJustifiable : public LedPrint
  {
    ...
    public:
       ...
       /** Instantiate an LedPrint with the given dataPin, clkPin, csPin and an optional
        ...
        LedPrintJustifiable (uint8_t dataPin, uint8_t clkPin, uint8_t csPin, uint8_t numDigits=8, uint8_t displayIsBackwards = 1, bool anode=false) :
          LedPrint( dataPin,  clkPin,  csPin,  numDigits, displayIsBackwards, anode) { };
