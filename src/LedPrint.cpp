...
LedPrint::LedPrint (uint8_t dataPin, uint8_t clkPin, uint8_t csPin, uint8_t numDigits, uint8_t displayIsBackwards, bool anode)
{
  _displayIsBackwards = displayIsBackwards;

  _lc = new LedControl(dataPin, clkPin, csPin, numDigits/8 + (numDigits%8?1:0), anode);
